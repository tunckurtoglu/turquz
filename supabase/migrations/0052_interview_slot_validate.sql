-- 0052_interview_slot_validate.sql
-- Aday yalnızca önerilen slotlardan birini seçebilir; geçmiş saat kabul edilmez.
...
begin
  ...
  -- Yalnızca acentenin önerdiği listeden seçim (slots kolonu jsonb).
  if proposed is null
