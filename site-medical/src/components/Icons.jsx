...
export const IconTooth = (p) => (<S {...p}><path d="M12 3c-2.2 0-3.5 1.4-4 3-.4 1.2-.6 2.4-.7 3.6-.1 1.4.1 2.9.6 4.2.4 1.1.5 2.3.3 3.5-.2 1.3-.8 2.6-1.2 3.7-.2.5 0 1.1.5 1.3.5.2 1.1 0 1.3-.5.4-1 .8-2.1 1-3.2.2-1.2.1-2.4-.2-3.5C10 13.5 10 11.8 10.2 10.2c.2-1.3.6-2.5 1.8-2.5s1.6 1.2 1.8 2.5c.2 1.6.2 3.3-.6 4.9-.3 1.1-.4 2.3-.2 3.5.2 1.1.6 2.2 1 3.2.2.5.8.7 1.3.5.5-.2.7-.8.5-1.3-.4-1.1-1-2.4-1.2-3.7-.2-1.2-.1-2.4.3-3.5.5-1.3.7-2.8.6-4.2C16.5 7.4 16.3 6.2 15.9 5 15.5 4.4 14.2 3 12 3z"/></S>);
export const IconEye = (p) => (<S {...p}><path d="M2 12s3.5-6 10-6 10 6 10 6-3.5 6-10 6S2 12 2 12z"/><circle cx="12" cy="12" r="2.8"/></S>);
