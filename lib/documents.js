...
// Acente: kendi gönderdiği sözleşmeyi / bileti geri al (RPC). Sözleşmede imzalı PDF de düşer.
...
// Acente: gönderilmiş belgeyi (uçak bileti) yeni PDF ile değiştir; submitted kalır → hire trigger tekrarlanmaz.
