...
function toRow(f, agencyId) {
  return {
    ...
    employer_name: f.employerName || null,
    employer_country: f.employerCountry || null,
    employer_city: f.employerCity || null,
    employer_region: f.employerRegion || null,
    employer_web_url: f.employerWebUrl || null,
...
function fromRow(r) {
  ...
  return {
    ...
    employerCountry: r.employer_country || '',
    employerCity: r.employer_city || '',
    employerRegion: r.employer_region || '',
    employerWebUrl: r.employer_web_url || '',
    paymentStatus,
