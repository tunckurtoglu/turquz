...
// KVKK Aydınlatma — uygulama içi sheet (App.js host). İsteğe bağlı web yedek URL.
export const PRIVACY_URL = 'https://turquz.com/kvkk';

let _privacyOpener = null;

/** App kökü PrivacyNoticeSheet'i kaydeder; openPrivacy() bunu çağırır. */
export function registerPrivacyOpener(fn) {
  _privacyOpener = typeof fn === 'function' ? fn : null;
}
...
export const TURQUZ_SUPPORT_EMAIL = 'info@turquz.com';
...
/** Gizlilik / KVKK metnini uygulama içinde aç (host yoksa web yedek). */
