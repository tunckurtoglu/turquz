...
export async function listStatuses() {
  const { data, error } = await supabase.from('candidate_status').select('user_id, docs_unlocked, stage, status, accepted_by, offered_at, offer_employer_id, docs_deadline_at, boarding_status, flight_depart_on');
  if (error) {
