...
export const CANDIDATE_DOCS = [
  ...
  { kind: 'diploma',         icon: '🎓', stage: 1, sensitive: false, required: true, langNote: true },
  { kind: 'criminal',        icon: '📄', stage: 1, sensitive: true,  required: true, langNote: true },
  { kind: 'contract_signed', icon: '✍️', stage: 2, sensitive: false, required: true },
